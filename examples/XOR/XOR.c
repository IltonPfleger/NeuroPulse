...
int main() {
    ...
    pulse_model model = pulse_create_model(2, pulse_create_dense_layer(2, 4, PULSE_ACTIVATION_RELU, PULSE_OPTIMIZATION_SIMD),
                                           pulse_create_dense_layer(4, 1, PULSE_ACTIVATION_RELU, PULSE_OPTIMIZATION_SIMD));
